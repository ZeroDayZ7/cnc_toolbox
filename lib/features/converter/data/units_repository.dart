...
final List<UnitDefinition> lengthUnits = [
  ...
  UnitDefinition(id: 'um', label: 'converter.units.um', symbol: 'µm', ratio: 0.000001),
  UnitDefinition(id: 'km', label: 'converter.units.km', symbol: 'km', ratio: 1000.0),
...
final List<UnitDefinition> tempUnits = [
  ...
  UnitDefinition(id: 'kelvin', label: 'converter.units.kelvin', symbol: 'K', ratio: 1.0),
];

final List<UnitDefinition> speedUnits = [
  UnitDefinition(id: 'm_s', label: LocaleKeys.converter_units_m_s, symbol: 'm/s', ratio: 1.0),
  UnitDefinition(id: 'km_h', label: 'converter.units.km_h', symbol: 'km/h', ratio: 1 / 3.6),
  UnitDefinition(id: 'mm_min', label: LocaleKeys.converter_units_mm_min, symbol: 'mm/min', ratio: 0.001 / 60),
  UnitDefinition(id: 'mm_s', label: 'converter.units.mm_s', symbol: 'mm/s', ratio: 0.001),
  UnitDefinition(id: 'in_min', label: 'converter.units.in_min', symbol: 'in/min', ratio: 0.0254 / 60),
];
...
final List<UnitDefinition> pressureUnits = [
  ...
  UnitDefinition(id: 'pa', label: 'converter.units.pa', symbol: 'Pa', ratio: 0.00001),
  UnitDefinition(id: 'mpa', label: 'converter.units.mpa', symbol: 'MPa', ratio: 10.0),
  UnitDefinition(id: 'atm', label: 'converter.units.atm', symbol: 'atm', ratio: 1.01325),
];